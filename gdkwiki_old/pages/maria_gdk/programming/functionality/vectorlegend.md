...
When running with multiple mapservices serving multiple instances of the same mappackage, make sure that all mappackages reference an identical set of setup files (featuregrouping.xml, mariner_settings.xml etc). If not - legend bitmaps might differ from what is visible in map view.
`</WRAP>`
...
The RasterResourceRequest should supply a resourceid-string with syntax: \\ //[mapsignature]//#//[dataset]//#//[featuregroup]//.

Example:
`<WRAP center round box 100%>`
*resourceid:* Norge2013#Norge N250#Arealdekke\Skog \\
*geotype:* Polygon \\
*rastersize:* Medium \\

Will return a medium sized bitmap representing a skog-polygon as defined by the "Norge N250" dataset referred to by the "Norge2013" mappackage.
`</WRAP>`
